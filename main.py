...
class MyApp(ShowBase):
    ...
    def startGame(self):
        ...
        self.music = base.loader.loadMusic(
            "assets/sounds/hytale-ost-kweebec-village.mp3")
        self.music.play()
    ...
    def loadEntities(self):
        ...
        self.slime = Slime(self.terrain, startingPoint, "assets/models/slime.egg",
                           10, 10, 100, 0.01, 5, self.dt, "slime", self.collision)
        self.spawn = Spawn([self.slime]+Monster.monster,
                           self.terrain, self.AIworld, self.collision)
        self.spawn.spawn()
    ...
    def updateCamera(self, task):
        if (self.state != 'Game'):
            return
        self.cam.setPos(self.slime.pos.getX(), self.slime.pos.getY(
        )-self.ydelta, self.slime.pos.getZ()+self.zdelta)
